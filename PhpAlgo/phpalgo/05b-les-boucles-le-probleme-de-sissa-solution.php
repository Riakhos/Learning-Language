...
// Etape 2 :
// A la fin dez votre programme, affichez le nombre total de grains de riz que le seigneur doit au vieux sage.
// Etape 3 :
...
echo 'Total de grains : ' . $total . "\n\r";
echo 'En kilo : ' . $total/3500 . 'kg' . "\n\r";
echo ' Soit : ' . $total/3500/1000 . ' de tonnes'. "\n\r";
echo ' Soit : ' . round($total/3500/1000/1000000000) . ' milliards de tonnes';