...
do {
    $iQui  = rand(0, count($tabQui)-1);
    $iQuoi = rand(0, count($tabQuoi)-1);
    $iAQui = rand(0, count($tabAQui)-1);
    $iOu   = rand(0, count($tabOu)-1);

    $scenario = $tabQui[$iQui] . ' ' . $tabQuoi[$iQuoi]  . ' ' . $tabAQui[$iAQui]  . ' ' . $tabOu[$iOu] . "\r\n";
    echo $scenario;

 } while (readline('Encore (o/n) ? ') == 'o');
